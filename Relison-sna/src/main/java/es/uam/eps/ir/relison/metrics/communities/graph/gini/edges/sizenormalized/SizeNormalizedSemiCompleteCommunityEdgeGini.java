 ...
 */
package es.uam.eps.ir.relison.metrics.communities.graph.gini.edges.sizenormalized;

import es.uam.eps.ir.relison.metrics.graph.EdgeGiniMode;
...
public class SizeNormalizedSemiCompleteCommunityEdgeGini<U> extends SizeNormalizedCommunityEdgeGini<U>
{
     ...
     */
    public SizeNormalizedSemiCompleteCommunityEdgeGini(boolean selfloops)
    {
