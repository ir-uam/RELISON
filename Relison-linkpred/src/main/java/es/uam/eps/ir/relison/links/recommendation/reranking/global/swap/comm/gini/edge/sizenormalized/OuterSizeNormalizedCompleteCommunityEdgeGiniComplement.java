 ...
 */
public class OuterSizeNormalizedCompleteCommunityEdgeGiniComplement<U> extends SizeNormalizedCompleteCommunityEdgeGiniComplement<U>
{
    /**
     * Constructor.
     ...
     */
    public OuterSizeNormalizedCompleteCommunityEdgeGiniComplement(double lambda, int cutoff, Supplier<Normalizer<U>> norm, Graph<U> graph, Communities<U> communities, boolean selfloops)
    {
