 ...
 *
 * Alternative reranker to the one implemented in es.uam.eps.ir.socialranksys.links.recommendation.reranking.global.swap.comm.gini.edge.SemiCompleteCommunityOuterEdgeGiniReranker.
 *
 ...
 */
public class OuterAlternativeSemiCompleteCommunityEdgeGiniComplement<U> extends CommunityReranker<U>
{
     ...
     */
    public OuterAlternativeSemiCompleteCommunityEdgeGiniComplement(double lambda, int cutoff, Supplier<Normalizer<U>> norm, Graph<U> graph, Communities<U> communities, boolean selfloops)
    {
    ...
    protected double novAddDelete(U u, Tuple2od<U> recommUser, Tuple2od<U> deleteUser)
    {
        ...
        if(this.graph.isDirected() || userComm < recommComm)
        {
