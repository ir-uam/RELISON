 ...
 */
public class OuterSizeNormalizedCompleteCommunityDegreeGiniComplement<U> extends SizeNormalizedCompleteCommunityDegreeGiniComplement<U>
{
    /**
     * Constructor.
     ...
     */
    public OuterSizeNormalizedCompleteCommunityDegreeGiniComplement(double lambda, int cutoff, Supplier<Normalizer<U>> norm, Graph<U> graph, Communities<U> communities, boolean selfloops, EdgeOrientation orientation)
    {
