 ...
 */
package es.uam.eps.ir.relison.content.index.lucene;

import es.uam.eps.ir.relison.content.index.AbstractIndex;
import es.uam.eps.ir.relison.content.index.exceptions.NoIndexException;
import es.uam.eps.ir.relison.content.index.structure.PostingsList;
import es.uam.eps.ir.relison.content.index.structure.lucene.LucenePostingsList;
