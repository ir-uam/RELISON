 ...
 */
public class FeatureGlobalUserGiniComplement<U extends Serializable,I extends Serializable,P> extends AbstractFeatureGlobalSimulationMetric<U,I,P>
{

    /**
     * Name fixed value.
     */
    private final static String GLOBALGINI = "global-feat-user-ginicompl";
     ...
     */
    public FeatureGlobalUserGiniComplement(String feature, boolean userFeat)
    {
