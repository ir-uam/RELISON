 ...
 */
public class CreatorGlobalEntropy<U extends Serializable,I extends Serializable, F> extends AbstractGlobalSimulationMetric<U,I, F>
{
    /**
     * Name fixed value.
     */
    private final static String ENTROPY = "global-creator-entropy";
     ...
     */
    public CreatorGlobalEntropy(boolean unique)
    {
