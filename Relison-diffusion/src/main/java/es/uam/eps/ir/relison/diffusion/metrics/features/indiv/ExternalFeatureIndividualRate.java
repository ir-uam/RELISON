 ...
 */
public class ExternalFeatureIndividualRate<U extends Serializable,I extends Serializable, F> extends AbstractExternalFeatureIndividualSimulationMetric<U,I, F>
{
    /**
     * Name fixed value.
     */
    private final static String EXTPARAMRATE = "indiv-ext-featrate";
     ...
     */
    public ExternalFeatureIndividualRate(String features, boolean userFeats, boolean unique)
    {
