 ...
 */
public class UserFeatureGiniComplement<U extends Serializable,I extends Serializable, F> extends AbstractFeatureGlobalSimulationMetric<U,I, F>
{
    /**
    * Metric name.
    */
     ...
     */
    public UserFeatureGiniComplement(String feature, boolean userFeat, boolean unique)
    {
