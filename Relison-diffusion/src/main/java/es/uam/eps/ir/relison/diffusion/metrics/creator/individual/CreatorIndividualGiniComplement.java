 ...
 */
package es.uam.eps.ir.relison.diffusion.metrics.creator.individual;
 ...
 */
public class CreatorIndividualGiniComplement<U extends Serializable,I extends Serializable, F> extends AbstractIndividualSimulationMetric<U,I, F>
{

    /**
     * Name fixed value.
     */
    private final static String GINI = "indiv-creator-gini";
     ...
     */
    public CreatorIndividualGiniComplement(boolean unique)
    {
