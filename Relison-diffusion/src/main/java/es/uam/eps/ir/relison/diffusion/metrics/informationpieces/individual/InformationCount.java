 ...
 */
package es.uam.eps.ir.relison.diffusion.metrics.informationpieces.individual;
 ...
 */
public class InformationCount<U extends Serializable,I extends Serializable, F> extends AbstractIndividualSimulationMetric<U,I, F>
{
    /**
     * Name fixed value.
     */
    private final static String SPEED = "information-count";
