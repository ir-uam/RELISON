...
import es.uam.eps.ir.socialranksys.metrics.distance.graph.ReciprocalAverageEccentricity;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.graph.GraphMetricIdentifiers.RECIPRAVGECCENTRICITY;
