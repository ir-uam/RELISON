...
import es.uam.eps.ir.socialranksys.metrics.pair.ReciprocityRate;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.pair.PairMetricIdentifiers.RECIP;
...
public class ReciprocityRateGridSearch<U> implements PairMetricGridSearch<U>
{
    ...
    public Map<String, Supplier<PairMetric<U>>> grid(Grid grid, DistanceCalculator<U> distCalc)
    {
        ...
        map.put(RECIP, ReciprocityRate::new);
        return map;
    }
    ...
    public Map<String, PairMetricFunction<U>> grid(Grid grid)
    {
        ...
        map.put(RECIP, (distCalc) -> new ReciprocityRate<>());
        return map;
    }
