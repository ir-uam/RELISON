...
import es.uam.eps.ir.socialranksys.diffusion.metrics.distributions.UserFeatureDistribution;
 ...
 *
 * @see UserFeatureDistribution
 */
public class UserFeatDistributionConfigurator<U extends Serializable,I extends Serializable, F> implements DistributionConfigurator<U,I, F>
{
    /**
    ...
    public Distribution<U, I, F> configure(Parameters params)
    {
        ...
        return new UserFeatureDistribution<>(parameter);
    }
