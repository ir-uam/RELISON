...
import es.uam.eps.ir.socialranksys.metrics.graph.NumEdges;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.graph.GraphMetricIdentifiers.NUMEDGES;
...
{    
    ...
    public Map<String, Supplier<GraphMetric<U>>> grid(Grid grid, DistanceCalculator<U> distCalc)
    {
        ...
        metrics.put(NUMEDGES, NumEdges::new);
        return metrics;
    }
    ...
    public Map<String, GraphMetricFunction<U>> grid(Grid grid)
    {
        ...
        metrics.put(NUMEDGES, (distCalc) -> new NumEdges<>());
        return metrics;
    }
