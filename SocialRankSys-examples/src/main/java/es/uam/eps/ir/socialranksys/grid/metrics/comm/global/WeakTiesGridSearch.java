...
import es.uam.eps.ir.socialranksys.metrics.communities.graph.WeakTies;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.comm.global.GlobalCommunityMetricIdentifiers.WEAKTIES;
...
public class WeakTiesGridSearch<U> implements GlobalCommunityMetricGridSearch<U> 
{
    ...
    public Map<String, Supplier<CommunityMetric<U>>> grid(Grid grid)
    {
        ...
        metrics.put(WEAKTIES, WeakTies::new);
