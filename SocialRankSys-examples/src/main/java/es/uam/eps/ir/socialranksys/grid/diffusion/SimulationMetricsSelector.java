...
public class SimulationMetricsSelector<U extends Serializable,I extends Serializable,P> 
{
     ...
     */
    public Triplet<DataFilter<U,I,P>,List<SimulationMetric<U,I,P>>,List<Tuple2<Distribution<U,I,P>, List<Integer>>>> select(YAMLSimulationMetricsParameterReader spr, P defaultValue)
    {
     ...
     * @return A triple containing a data filter, a list of simulation metrics and a list of distributions
     */
    public Triplet<DataFilter<U,I,P>,List<SimulationMetric<U,I,P>>,List<Tuple2<Distribution<U,I,P>, List<Integer>>>> select(YAMLSimulationMetricsParameterReader spr, P defaultValue, Graph<U> testGraph)
    {
        if(spr == null)
            return null;
        ...
        List<YAMLFilterParameterReader> filters = spr.getFiltersParameters();
