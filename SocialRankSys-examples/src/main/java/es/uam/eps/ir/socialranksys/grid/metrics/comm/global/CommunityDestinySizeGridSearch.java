...
import es.uam.eps.ir.socialranksys.metrics.communities.graph.CommunityDestinySize;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.comm.global.GlobalCommunityMetricIdentifiers.COMMDESTSIZE;
...
public class CommunityDestinySizeGridSearch<U> implements GlobalCommunityMetricGridSearch<U> 
{
    ...
    public Map<String, Supplier<CommunityMetric<U>>> grid(Grid grid)
    {
        ...
        map.put(COMMDESTSIZE, CommunityDestinySize::new);
        return map;
    }
