 ...
 */
package es.uam.eps.ir.socialranksys.grid.links.recommendation.algorithms.standalone.baselines;
...
import es.uam.eps.ir.socialranksys.links.recommendation.algorithms.standalone.basic.Popularity;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.links.recommendation.algorithms.AlgorithmIdentifiers.POP;
