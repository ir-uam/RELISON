 ...
 *
 * @see es.uam.eps.ir.socialranksys.grid.YAMLParametersReader
 */
public class YAMLMetricParametersReader extends YAMLParametersReader
{
    /**
     ...
     * metric.
     */
    private final Map<String, Map<String, Parameters>> metricsGrid;


    /**
     * Constructor.
     */
    public YAMLMetricParametersReader()
    {
    ...
    private void readMetric(Map.Entry<String, Object> element)
    {
        ...
        if(metricsGrid.containsKey(metricType))
        {
            ...
            {
                metricsGrid.get(metricType).put(metricName, new Parameters());
            }
            else
            {
                Object params = metricObject.get(PARAMS);
                Map<String, Object> parameters = (Map<String, Object>) params;
                Parameters g = this.readParameterValues(parameters);
     ...
     * @return the set of metrics of the given metric which have been retrieved.
     */
    public Parameters getGrid(String metric, String type)
    {
        return this.metricsGrid.get(type).getOrDefault(metric, new Parameters());
    }
}
