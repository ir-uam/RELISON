...
import es.uam.eps.ir.socialranksys.diffusion.metrics.features.global.FeatureGlobalEntropy;
import es.uam.eps.ir.socialranksys.diffusion.metrics.features.global.FeatureGlobalGini;
...
/**
 * Configures a metric that measures the entropy over the features which have been received by the users.
 *
 ...
 *
 * @see FeatureGlobalEntropy
 */
public class FeatureGlobalGiniMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureGlobalGini<>(feature, userFeat, unique);
    }
