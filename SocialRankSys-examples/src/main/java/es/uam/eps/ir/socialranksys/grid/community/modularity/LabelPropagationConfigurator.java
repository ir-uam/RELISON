...
import es.uam.eps.ir.socialranksys.community.detection.modularity.LabelPropagation;
...
import static es.uam.eps.ir.socialranksys.grid.community.CommunityDetectionIdentifiers.LABELPROP;
 ...
 *
 * @see es.uam.eps.ir.socialranksys.community.detection.modularity.LabelPropagation
 */
public class LabelPropagationConfigurator<U extends Serializable> implements CommunityDetectionConfigurator<U>
{
    @Override
    public Map<String, Supplier<CommunityDetectionAlgorithm<U>>> configure(Grid grid)
    {
        ...
        map.put(LABELPROP, LabelPropagation::new);
        return map;
    }
}
