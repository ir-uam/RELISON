 ...
 */
package es.uam.eps.ir.socialranksys.grid.metrics.comm.global.gini.size;
...
import es.uam.eps.ir.socialranksys.metrics.communities.graph.gini.size.CommunitySizeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.comm.global.GlobalCommunityMetricIdentifiers.COMMSIZEGINI;
