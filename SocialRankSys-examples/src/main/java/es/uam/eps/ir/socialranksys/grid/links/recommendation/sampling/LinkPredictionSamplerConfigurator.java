...
import es.uam.eps.ir.socialranksys.links.data.letor.sampling.LinkPredictionSampler;
 ...
 */
public class LinkPredictionSamplerConfigurator<U> implements IndividualSamplingAlgorithmConfigurator<U>
{
    @Override
    ...
    {
        String name = IndividualSamplingAlgorithmIdentifiers.LINKPRED;
        IndividualSampler<U> sampler = new LinkPredictionSampler<>(trainGraph, testGraph);
    ...
    public Tuple2<String, IndividualSamplerFunction<U>> grid(Parameters params)
    {
        ...
        IndividualSamplerFunction<U> function = (FastGraph<U> trainGraph, FastGraph<U> testGraph, FastPreferenceData<U,U> prefData) ->
                new LinkPredictionSampler<>(trainGraph, testGraph);
