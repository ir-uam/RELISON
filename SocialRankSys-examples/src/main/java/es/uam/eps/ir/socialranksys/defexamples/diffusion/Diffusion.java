...
import es.uam.eps.ir.socialranksys.grid.diffusion.YAMLSimulationParameterReader;
...
public class Diffusion
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        YAMLSimulationParameterReader simReader = new YAMLSimulationParameterReader();
