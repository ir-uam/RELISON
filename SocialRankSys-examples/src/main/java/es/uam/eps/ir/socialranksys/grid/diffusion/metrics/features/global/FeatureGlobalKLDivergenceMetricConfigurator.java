...
import es.uam.eps.ir.socialranksys.diffusion.metrics.features.global.FeatureGlobalKLDivergence;
 ...
 *
 * @see FeatureGlobalKLDivergence
 */
public class FeatureGlobalKLDivergenceMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureGlobalKLDivergence<>(feature, userFeats, unique);
    }
