...
import es.uam.eps.ir.socialranksys.metrics.communities.graph.gini.edges.sizenormalized.SizeNormalizedInterCommunityEdgeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.comm.global.GlobalCommunityMetricIdentifiers.SIZENORMINTERCOMMUNITYEDGEGINI;
