 ...
 */
package es.uam.eps.ir.socialranksys.defexamples.diffusion;
...
import es.uam.eps.ir.socialranksys.grid.diffusion.YAMLSimulationMetricsParameterReader;
...
public class DiffusionEvaluation
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        YAMLSimulationMetricsParameterReader simReader = new YAMLSimulationMetricsParameterReader();
