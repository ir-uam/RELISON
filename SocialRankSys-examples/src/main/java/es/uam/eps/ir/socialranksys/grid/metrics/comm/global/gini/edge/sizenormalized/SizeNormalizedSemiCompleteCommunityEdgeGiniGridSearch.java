 ...
 */
package es.uam.eps.ir.socialranksys.grid.metrics.comm.global.gini.edge.sizenormalized;
...
import es.uam.eps.ir.socialranksys.metrics.communities.graph.gini.edges.sizenormalized.SizeNormalizedSemiCompleteCommunityEdgeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.socialranksys.grid.metrics.comm.global.GlobalCommunityMetricIdentifiers.SIZENORMSEMICOMPLETECOMMUNITYEDGEGINI;
...
public class SizeNormalizedSemiCompleteCommunityEdgeGiniGridSearch<U> implements GlobalCommunityMetricGridSearch<U>
{
    ...
    public Map<String, Supplier<CommunityMetric<U>>> grid(Grid grid)
    {
        ...
        grid.getBooleanValues(NODEAUTOLOOPS).forEach(autoloops -> 
            metrics.put(SIZENORMSEMICOMPLETECOMMUNITYEDGEGINI + "_"  + (autoloops ? "autoloops" : "noautoloops"), () -> new SizeNormalizedSemiCompleteCommunityEdgeGini<>(autoloops)));
