...
import static es.uam.eps.ir.socialranksys.grid.links.recommendation.rerankers.RerankerIdentifiers.SNICEDGEGINI;
...
public class SizeNormInterCommunityEdgeGiniRerankerGridSearch<U> implements RerankerGridSearch<U>
{
     ...
     */
    public SizeNormInterCommunityEdgeGiniRerankerGridSearch(int cutoff, boolean norm, boolean rank, Graph<U> graph, Communities<U> comms)
    {
        this.cutoff = cutoff;
        this.norm = norm;
        this.graph = graph;
