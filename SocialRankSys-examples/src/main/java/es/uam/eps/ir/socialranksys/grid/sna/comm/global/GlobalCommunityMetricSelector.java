...
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.degree.CompleteCommunityDegreeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.degree.InterCommunityDegreeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.degree.sizenormalized.SizeNormalizedCompleteCommunityDegreeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.degree.sizenormalized.SizeNormalizedInterCommunityDegreeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.CompleteCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.InterCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.SemiCompleteCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.dice.DiceCompleteCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.dice.DiceInterCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.dice.DiceSemiCompleteCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.sizenormalized.SizeNormalizedCompleteCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.sizenormalized.SizeNormalizedInterCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.edge.sizenormalized.SizeNormalizedSemiCompleteCommunityEdgeGiniGridSearch;
import es.uam.eps.ir.socialranksys.grid.sna.comm.global.gini.size.CommunitySizeGiniGridSearch;
...
import static es.uam.eps.ir.socialranksys.grid.sna.comm.global.GlobalCommunityMetricIdentifiers.*;
