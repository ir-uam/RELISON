...
import es.uam.eps.ir.socialranksys.diffusion.metrics.features.global.FeatureGlobalKLDivergenceInverse;
 ...
 *
 * @see FeatureGlobalKLDivergenceInverse
 */
public class FeatureGlobalKLDivergenceInverseMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        if(feature == null || userFeats == null || unique == null)
            return null;
        
        return new FeatureGlobalKLDivergenceInverse<>(feature, userFeats, unique);
    }
