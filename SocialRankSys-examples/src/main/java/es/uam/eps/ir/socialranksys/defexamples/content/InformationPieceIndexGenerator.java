 ...
 */
package es.uam.eps.ir.socialranksys.defexamples.content;

import es.uam.eps.ir.socialranksys.content.index.AbstractIndexBuilder;
import es.uam.eps.ir.socialranksys.content.index.individual.IndividualContentIndexBuilder;
import es.uam.eps.ir.socialranksys.content.index.individual.WrapperIndividualContentIndexBuilder;
