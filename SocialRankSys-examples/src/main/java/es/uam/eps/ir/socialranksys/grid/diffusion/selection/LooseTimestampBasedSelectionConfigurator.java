 ...
 *
 * @see LooseTimestampBasedSelectionMechanism
 */
public class LooseTimestampBasedSelectionConfigurator<U extends Serializable,I extends Serializable, F> implements SelectionConfigurator<U,I, F>
{
    @Override
