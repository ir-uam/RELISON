...
import es.uam.eps.ir.socialranksys.diffusion.stop.NoMoreTimestampsStopCondition;
 ...
 */
public class NoMoreTimestampsStopConditionConfigurator<U extends Serializable,I extends Serializable,F> implements StopConditionConfigurator<U,I,F>
{
    @Override
