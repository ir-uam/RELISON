...
import static es.uam.eps.ir.socialranksys.grid.metrics.pair.PairMetricIdentifiers.GEODESICS;
...
{   
    ...
    public Map<String, Supplier<PairMetric<U>>> grid(Grid grid, DistanceCalculator<U> distCalc)
    {
        ...
        map.put(GEODESICS, () -> new Geodesics<>(distCalc));
        return map;
    }
    ...
    public Map<String, PairMetricFunction<U>> grid(Grid grid)
    {
        ...
        map.put(GEODESICS, Geodesics::new);
        return map;
    }
