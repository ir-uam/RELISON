...
import es.uam.eps.ir.relison.graph.fast.FastDirectedWeightedGraph;
...
public class DirectedWeightedGraphTest
{
    ...
    public void mutualTest()
    {
        ...
        // Guard the random sampling: depending on the randomly chosen probability, the generated data may contain
        // no mutual (or no non-mutual) edges, in which case nextInt(0) would throw "bound must be positive".
