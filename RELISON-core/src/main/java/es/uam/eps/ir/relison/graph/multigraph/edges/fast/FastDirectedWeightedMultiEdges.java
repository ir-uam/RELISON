...
import es.uam.eps.ir.relison.graph.multigraph.edges.WeightedMultiEdges;
...
public class FastDirectedWeightedMultiEdges extends FastMultiEdges implements DirectedMultiEdges, WeightedMultiEdges
{
    ...
    public boolean removeEdges(int orig, int dest)
    {
        ...
        if (this.weights.removePair(orig, dest) && this.types.removePair(orig, dest) && this.ids.removePair(orig, dest))
        {
