 ...
 */
package es.uam.eps.ir.sonalire.links.recommendation.reranking.global.globalranking.edge;
...
public class DirectEdgeMetricReranker<U> extends EdgeMetricReranker<U>
{
     ...
     */
    public DirectEdgeMetricReranker(double lambda, int cutoff, Supplier<Normalizer<U>> norm, Graph<U> graph, PairMetric<U> metric)
    {
