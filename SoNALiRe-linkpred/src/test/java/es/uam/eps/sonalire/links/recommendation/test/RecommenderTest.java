 ...
 */
package es.uam.eps.sonalire.links.recommendation.test;
...
import es.uam.eps.ir.sonalire.links.recommendation.algorithms.standalone.distance.ShortestDistance;
import es.uam.eps.ir.sonalire.links.recommendation.algorithms.standalone.foaf.*;
import es.uam.eps.ir.sonalire.links.recommendation.algorithms.standalone.ir.*;
import org.junit.*;
