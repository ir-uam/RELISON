...
import es.uam.eps.ir.sonalire.diffusion.metrics.informationpieces.global.InformationPieceGiniComplement;
 ...
 */
public class InformationGiniMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    @Override
