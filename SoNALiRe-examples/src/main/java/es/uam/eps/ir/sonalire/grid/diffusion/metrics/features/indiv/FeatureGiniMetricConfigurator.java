...
import es.uam.eps.ir.sonalire.diffusion.metrics.features.indiv.FeatureGini;
 ...
 * @see FeatureGini
 */
public class FeatureGiniMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureGini<>(feature, userFeat, unique);
    }
