...
import es.uam.eps.ir.sonalire.diffusion.metrics.features.indiv.ExternalFeatureGini;
 ...
 *
 * @see ExternalFeatureGini
 */
public class ExternalFeatureGiniMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new ExternalFeatureGini<>(feature, userFeat, unique);
    }
