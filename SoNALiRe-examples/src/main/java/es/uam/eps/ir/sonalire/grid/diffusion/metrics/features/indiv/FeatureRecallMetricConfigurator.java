 ...
 * @see FeatureRecall
 */
public class FeatureRecallMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    /**
     * Identifier for the parameter which identifies if the studied feature is an user or an information piece feature.
     */
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureRecall<>(feature, userFeat);
    }
