package es.uam.eps.ir.sonalire.ecir2019;
...
import es.uam.eps.ir.sonalire.graph.fast.FastDirectedWeightedGraph;
...
import es.uam.eps.ir.sonalire.links.data.updateable.index.fast.FastUpdateableGraphIndex;
import es.uam.eps.ir.sonalire.links.data.updateable.preference.fast.updateable.FastUpdateablePreferenceData;
import es.uam.eps.ir.sonalire.links.data.updateable.preference.fast.updateable.GraphSimpleUpdateableFastPreferenceData;
...
import es.uam.eps.ir.sonalire.links.recommendation.updateable.ir.UpdateableBM25;
import es.uam.eps.ir.sonalire.links.recommendation.updateable.knn.sim.UpdateableGraphCosineSimilarity;
import es.uam.eps.ir.sonalire.links.recommendation.updateable.knn.sim.UpdateableGraphSimilarity;
import es.uam.eps.ir.sonalire.links.recommendation.updateable.knn.user.UpdateableUBkNN;
import es.uam.eps.ir.sonalire.links.recommendation.updateable.mf.MFGraphUpdateableRecommender;
import es.uam.eps.ir.sonalire.links.recommendation.updateable.mf.UpdateableFactorization;
import es.uam.eps.ir.sonalire.links.recommendation.updateable.mf.UpdateableFactorizer;
import es.uam.eps.ir.sonalire.links.recommendation.updateable.mf.als.HKVUpdateableFactorizer;
...
import static es.uam.eps.ir.sonalire.graph.edges.EdgeOrientation.*;
