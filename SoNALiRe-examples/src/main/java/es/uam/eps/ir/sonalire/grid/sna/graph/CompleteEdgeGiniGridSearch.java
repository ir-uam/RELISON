...
import es.uam.eps.ir.sonalire.metrics.graph.CompleteEdgeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.sonalire.grid.sna.graph.GraphMetricIdentifiers.COMPLETEEDGEGINI;
