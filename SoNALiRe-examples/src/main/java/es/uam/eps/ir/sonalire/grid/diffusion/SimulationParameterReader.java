...
import es.uam.eps.ir.sonalire.grid.diffusion.protocol.ProtocolParameterReader;
import es.uam.eps.ir.sonalire.grid.diffusion.stop.StopConditionParameterReader;
