 ...
 */
package es.uam.eps.ir.sonalire.grid.diffusion.metrics.users;

import es.uam.eps.ir.sonalire.diffusion.metrics.SimulationMetric;
import es.uam.eps.ir.sonalire.diffusion.metrics.user.global.UserGlobalEntropy;
 ...
 */
public class UserGlobalEntropyMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
