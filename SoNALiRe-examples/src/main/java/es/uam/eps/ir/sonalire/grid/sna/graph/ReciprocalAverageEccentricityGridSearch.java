...
import es.uam.eps.ir.sonalire.metrics.distance.graph.ReciprocalAverageEccentricity;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.sonalire.grid.sna.graph.GraphMetricIdentifiers.RECIPRAVGECCENTRICITY;
