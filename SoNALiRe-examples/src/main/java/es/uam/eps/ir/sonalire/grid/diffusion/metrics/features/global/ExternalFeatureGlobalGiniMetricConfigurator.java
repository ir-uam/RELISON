...
import es.uam.eps.ir.sonalire.diffusion.metrics.features.global.ExternalFeatureGlobalGini;
 ...
 */
public class ExternalFeatureGlobalGiniMetricConfigurator<U extends Serializable,I extends Serializable,F> implements MetricConfigurator<U,I,F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new ExternalFeatureGlobalGini<>(feature, userFeat, unique);
    }
