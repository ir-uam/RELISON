...
import es.uam.eps.ir.sonalire.links.recommendation.algorithms.standalone.twitter.Closure;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.sonalire.grid.links.recommendation.algorithms.AlgorithmIdentifiers.CLOSURE;
