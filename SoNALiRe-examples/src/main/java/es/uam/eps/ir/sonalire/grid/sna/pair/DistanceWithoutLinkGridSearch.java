...
import es.uam.eps.ir.sonalire.metrics.pair.DistanceWithoutLink;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.sonalire.grid.sna.pair.PairMetricIdentifiers.DISTANCEWITHOUTLINK;
