 ...
 */
package es.uam.eps.ir.sonalire.grid.sna.comm.global.gini.edge;
...
import es.uam.eps.ir.sonalire.metrics.communities.graph.gini.edges.InterCommunityEdgeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.sonalire.grid.sna.comm.global.GlobalCommunityMetricIdentifiers.INTERCOMMUNITYEDGEGINI;
...
public class InterCommunityEdgeGiniGridSearch<U> implements GlobalCommunityMetricGridSearch<U>
{
    ...
    public Map<String, Supplier<CommunityMetric<U>>> grid(Grid grid)
    {
        ...
        metrics.put(INTERCOMMUNITYEDGEGINI, InterCommunityEdgeGini::new);
