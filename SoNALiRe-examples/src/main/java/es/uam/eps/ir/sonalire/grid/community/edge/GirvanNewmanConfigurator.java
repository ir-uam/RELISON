 ...
 */
package es.uam.eps.ir.sonalire.grid.community.edge;

import es.uam.eps.ir.sonalire.community.detection.CommunityDetectionAlgorithm;
import es.uam.eps.ir.sonalire.community.detection.edge.GirvanNewman;
...
import static es.uam.eps.ir.sonalire.grid.community.CommunityDetectionIdentifiers.GIRVANNEWMAN;
