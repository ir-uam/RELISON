...
import static es.uam.eps.ir.sonalire.grid.diffusion.update.UpdateMechanismIdentifiers.NEWEST;
import static es.uam.eps.ir.sonalire.grid.diffusion.update.UpdateMechanismIdentifiers.OLDER;
