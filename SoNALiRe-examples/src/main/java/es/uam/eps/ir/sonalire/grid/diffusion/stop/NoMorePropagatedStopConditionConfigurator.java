...
import es.uam.eps.ir.sonalire.diffusion.stop.NoMorePropagatedInfoStopCondition;
 ...
 */
public class NoMorePropagatedStopConditionConfigurator<U extends Serializable,I extends Serializable,F> implements StopConditionConfigurator<U,I,F>
{
    @Override
