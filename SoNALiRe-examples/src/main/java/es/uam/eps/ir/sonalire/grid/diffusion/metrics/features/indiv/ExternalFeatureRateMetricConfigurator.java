...
import es.uam.eps.ir.sonalire.diffusion.metrics.features.indiv.ExternalFeatureRate;
 ...
 *
 * @see ExternalFeatureRate
 */
public class ExternalFeatureRateMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    {
        String parameter = params.getStringValue(FEATURE);
        Boolean userFeats = params.getBooleanValue(USERFEAT);
        Boolean unique = params.getBooleanValue(UNIQUE);
        
        if(parameter == null || userFeats == null || unique == null)
            return null;
        
        return new ExternalFeatureRate<>(parameter, userFeats, unique);
    }
