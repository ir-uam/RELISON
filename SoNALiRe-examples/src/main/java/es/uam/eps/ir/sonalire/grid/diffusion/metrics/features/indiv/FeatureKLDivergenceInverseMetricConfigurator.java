 ...
 */
package es.uam.eps.ir.sonalire.grid.diffusion.metrics.features.indiv;

import es.uam.eps.ir.sonalire.diffusion.metrics.SimulationMetric;
import es.uam.eps.ir.sonalire.diffusion.metrics.features.indiv.FeatureKLDivergenceInverse;
...
/**
 * Configures a metric that measures the inverse of the Kullback-Leibler divergence of the features that a single user has received.
 *
 ...
 *
 * @see FeatureKLDivergenceInverse
 */
public class FeatureKLDivergenceInverseMetricConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureKLDivergenceInverse<>(feature, userFeat, unique);
    }
