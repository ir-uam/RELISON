...
import es.uam.eps.ir.sonalire.metrics.distance.pair.ReciprocalShortestPathLength;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.sonalire.grid.sna.pair.PairMetricIdentifiers.RECIPROCALSPL;
