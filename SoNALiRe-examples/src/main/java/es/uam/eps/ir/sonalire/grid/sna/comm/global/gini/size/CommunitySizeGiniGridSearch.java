 ...
 */
package es.uam.eps.ir.sonalire.grid.sna.comm.global.gini.size;
...
import es.uam.eps.ir.sonalire.metrics.communities.graph.gini.size.CommunitySizeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.sonalire.grid.sna.comm.global.GlobalCommunityMetricIdentifiers.COMMSIZEGINI;
