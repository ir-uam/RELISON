...
import es.uam.eps.ir.relison.diffusion.metrics.informationpieces.individual.InformationCount;
 ...
 *
 * @see InformationCount
 */
public class InformationCountConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    @Override
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        return new InformationCount<>();
    }
}
