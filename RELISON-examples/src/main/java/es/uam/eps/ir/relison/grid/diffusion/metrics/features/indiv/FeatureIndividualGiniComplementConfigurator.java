...
import es.uam.eps.ir.relison.diffusion.metrics.features.indiv.FeatureIndividualGini;
 ...
 *
 * @see FeatureIndividualGini
 */
public class FeatureIndividualGiniComplementConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureIndividualGini<>(feature, userFeat, unique);
    }
