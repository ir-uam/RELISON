...
import es.uam.eps.ir.relison.sna.metrics.communities.graph.gini.edges.InterCommunityEdgeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.relison.grid.sna.comm.global.GlobalCommunityMetricIdentifiers.INTERCOMMUNITYEDGEGINI;
