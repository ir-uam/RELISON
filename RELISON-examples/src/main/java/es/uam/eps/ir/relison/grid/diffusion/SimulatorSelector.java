...
import es.uam.eps.ir.relison.diffusion.data.filter.CombinedFilter;
...
import es.uam.eps.ir.relison.grid.diffusion.filter.FilterSelector;
import es.uam.eps.ir.relison.grid.diffusion.protocol.ProtocolSelector;
import es.uam.eps.ir.relison.grid.diffusion.stop.StopConditionSelector;
