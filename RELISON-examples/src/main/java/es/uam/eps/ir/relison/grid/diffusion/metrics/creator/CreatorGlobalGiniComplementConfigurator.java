...
import es.uam.eps.ir.relison.diffusion.metrics.creator.global.CreatorGlobalGiniComplement;
 ...
 *
 * @see CreatorGlobalGiniComplement
 */
public class CreatorGlobalGiniComplementConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new CreatorGlobalGiniComplement<>(unique);
    }
