...
import es.uam.eps.ir.relison.diffusion.metrics.distributions.UserDistribution;
 ...
 *
 * @see UserDistribution
 */
public class UserDistributionConfigurator<U extends Serializable,I extends Serializable, F> implements DistributionConfigurator<U,I, F>
{
