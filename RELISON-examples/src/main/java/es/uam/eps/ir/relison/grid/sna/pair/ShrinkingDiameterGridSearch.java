...
import es.uam.eps.ir.relison.sna.metrics.distance.pair.ShrinkingDiameter;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.relison.grid.sna.pair.PairMetricIdentifiers.SHRINKINGDIAM;
