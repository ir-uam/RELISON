...
import es.uam.eps.ir.relison.diffusion.metrics.creator.individual.CreatorIndividualEntropy;
 ...
 *
 * @see CreatorIndividualEntropy
 */
public class CreatorIndividualEntropyConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new CreatorIndividualEntropy<>(unique);
    }
}
