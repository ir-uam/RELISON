...
import es.uam.eps.ir.relison.graph.complementary.DirectedUnweightedComplementaryGraph;
import es.uam.eps.ir.relison.graph.complementary.DirectedWeightedComplementaryGraph;
import es.uam.eps.ir.relison.graph.complementary.UndirectedUnweightedComplementaryGraph;
import es.uam.eps.ir.relison.graph.complementary.UndirectedWeightedComplementaryGraph;
