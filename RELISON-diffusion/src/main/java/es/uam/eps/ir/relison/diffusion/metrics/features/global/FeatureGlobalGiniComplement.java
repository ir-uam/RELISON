 ...
 */
public class FeatureGlobalGiniComplement<U extends Serializable,I extends Serializable, F> extends AbstractFeatureGlobalSimulationMetric<U,I, F>
{

    /**
     * Name fixed value
     */
    private final static String GLOBALGINI = "global-feat-ginicompl";
     ...
     */
    public FeatureGlobalGiniComplement(String feature, boolean userFeats, boolean unique)
    {
