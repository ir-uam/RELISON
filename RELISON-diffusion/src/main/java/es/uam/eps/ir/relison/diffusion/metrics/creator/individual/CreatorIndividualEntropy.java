 ...
 */
public class CreatorIndividualEntropy<U extends Serializable,I extends Serializable, F> extends AbstractIndividualSimulationMetric<U,I, F>
{

    /**
     * Name fixed value.
     */
    private final static String ENTROPY = "indiv-creator-entropy";
     ...
     */
    public CreatorIndividualEntropy(boolean unique)
    {
