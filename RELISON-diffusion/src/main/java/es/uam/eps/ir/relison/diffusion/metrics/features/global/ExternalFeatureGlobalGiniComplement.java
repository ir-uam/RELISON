 ...
 */
public class ExternalFeatureGlobalGiniComplement<U extends Serializable,I extends Serializable, F> extends AbstractExternalFeatureGlobalSimulationMetric<U,I, F>
{
    /**
     * Name fixed value.
     */
    private final static String GLOBALGINI = "global-ext-feat-ginicompl";
     ...
     */
    public ExternalFeatureGlobalGiniComplement(String feature, boolean userFeat, boolean unique)
    {
