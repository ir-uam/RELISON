...
import es.uam.eps.ir.sonalire.metrics.distance.graph.ASL;
import es.uam.eps.ir.sonalire.metrics.distance.graph.Diameter;
import es.uam.eps.ir.sonalire.metrics.distance.modes.ASLMode;
import es.uam.eps.ir.sonalire.metrics.distance.pair.EdgeBetweenness;
import es.uam.eps.ir.sonalire.metrics.distance.pair.Geodesics;
import es.uam.eps.ir.sonalire.metrics.distance.vertex.Closeness;
import es.uam.eps.ir.sonalire.metrics.distance.vertex.Eccentricity;
import es.uam.eps.ir.sonalire.metrics.distance.vertex.HarmonicCentrality;
import es.uam.eps.ir.sonalire.metrics.distance.vertex.NodeBetweenness;
import org.junit.*;
