package es.uam.eps.ir.sonalire.community.detection.edge;

import es.uam.eps.ir.sonalire.community.Communities;
import es.uam.eps.ir.sonalire.community.Dendogram;
import es.uam.eps.ir.sonalire.community.detection.CommunityDetectionAlgorithm;
import es.uam.eps.ir.sonalire.community.detection.DendogramCommunityDetectionAlgorithm;
import es.uam.eps.ir.sonalire.community.detection.connectedness.WeaklyConnectedComponents;
import es.uam.eps.ir.sonalire.graph.Graph;
import es.uam.eps.ir.sonalire.graph.generator.GraphCloneGenerator;
import es.uam.eps.ir.sonalire.graph.generator.SubGraphGenerator;
...
import es.uam.eps.ir.sonalire.metrics.communities.graph.Modularity;
