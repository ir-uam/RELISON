...
public class TuplesLinkPredictionFormat<U> implements LinkPredictionFormat<U>
{
    ...
    @Override
    public LinkPredictionFormat.Writer<U> getWriter(OutputStream out) throws IOException
    {
        return new Writer(out);
    }

    @Override
    public LinkPredictionFormat.Reader<U> getReader(InputStream in) throws IOException
    {
