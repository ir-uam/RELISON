...
import es.uam.eps.ir.socialranksys.links.recommendation.standalone.bipartite.CentroidCosineSimilarity;
...
public class TwitterCentroidCosineSimilarity<U> extends TwitterRecommender<U>
{
    ...
    public Int2DoubleMap getScoresMap(int uIdx) 
    {
        ...
        BipartiteRecommender<U> rec = new CentroidCosineSimilarity<>(graph);
