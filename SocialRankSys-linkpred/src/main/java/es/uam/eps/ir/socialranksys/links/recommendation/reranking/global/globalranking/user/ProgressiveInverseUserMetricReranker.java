 ...
 */
package es.uam.eps.ir.socialranksys.links.recommendation.reranking.global.globalranking.user;
...
public class ProgressiveInverseUserMetricReranker<U> extends UserMetricReranker<U>
{
     ...
     */
    public ProgressiveInverseUserMetricReranker(double lambda, int cutoff, Supplier<Normalizer<U>> norm, Graph<U> graph, VertexMetric<U> metric)
    {
