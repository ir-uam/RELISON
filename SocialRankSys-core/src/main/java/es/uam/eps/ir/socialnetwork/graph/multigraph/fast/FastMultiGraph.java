...
public abstract class FastMultiGraph<U> implements MultiGraph<U>, Serializable
{
    ...
    public Stream<U> getNodesWithEdges(EdgeOrientation orient)
    {
        ...
        {
            case IN:
                return this.edges.getNodesWithIncidentEdges().mapToObj(vertices::idx2object);
            case OUT:
                return this.edges.getNodesWithAdjacentEdges().mapToObj(vertices::idx2object);
            case UND:
                return this.edges.getNodesWithEdges().mapToObj(vertices::idx2object);
            case MUTUAL:
                return this.edges.getNodesWithMutualEdges().mapToObj(vertices::idx2object);
            default:
                return null;
        }
    }
