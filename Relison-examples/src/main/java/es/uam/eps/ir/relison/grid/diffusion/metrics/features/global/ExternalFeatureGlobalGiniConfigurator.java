...
import es.uam.eps.ir.relison.diffusion.metrics.features.global.ExternalFeatureGlobalGiniComplement;
 ...
 *
 * @see ExternalFeatureGlobalGiniComplement
 */
public class ExternalFeatureGlobalGiniConfigurator<U extends Serializable,I extends Serializable,F> implements MetricConfigurator<U,I,F>
{
    /**
     ...
     */
    private final static String USERFEATURE = "userFeature";
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        Boolean userFeat = params.getBooleanValue(USERFEATURE);
        Boolean unique = params.getBooleanValue(UNIQUE);
        if(feature == null || userFeat == null || unique == null)
            return null;
        
        return new ExternalFeatureGlobalGiniComplement<>(feature, userFeat, unique);
    }
