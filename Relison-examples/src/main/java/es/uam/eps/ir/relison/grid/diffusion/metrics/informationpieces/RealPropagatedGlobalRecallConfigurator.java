...
import es.uam.eps.ir.relison.diffusion.metrics.informationpieces.global.RealPropagatedGlobalRecall;
 ...
 *
 * @see RealPropagatedGlobalRecall
 */
public class RealPropagatedGlobalRecallConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    @Override
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        return new RealPropagatedGlobalRecall<>();
    }
