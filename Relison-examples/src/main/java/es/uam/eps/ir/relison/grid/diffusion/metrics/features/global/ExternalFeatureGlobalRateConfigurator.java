...
import es.uam.eps.ir.relison.diffusion.metrics.features.global.ExternalFeatureGlobalRate;
 ...
 *
 * @see ExternalFeatureGlobalRate
 */
public class ExternalFeatureGlobalRateConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new ExternalFeatureGlobalRate<>(feature, userFeat, unique);
    }
