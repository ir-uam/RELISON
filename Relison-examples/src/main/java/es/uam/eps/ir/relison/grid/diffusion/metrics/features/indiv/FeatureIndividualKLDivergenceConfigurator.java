...
import es.uam.eps.ir.relison.diffusion.metrics.features.indiv.FeatureIndividualKLDivergence;
 ...
 *
 * @see FeatureIndividualKLDivergence
 */
public class FeatureIndividualKLDivergenceConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureIndividualKLDivergence<>(feature, userFeat, unique);
    }
