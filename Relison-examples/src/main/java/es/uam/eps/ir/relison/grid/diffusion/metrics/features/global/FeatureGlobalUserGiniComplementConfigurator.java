...
import es.uam.eps.ir.relison.diffusion.metrics.features.global.FeatureGlobalUserGiniComplement;
 ...
 *
 * @see FeatureGlobalUserGiniComplement
 */
public class FeatureGlobalUserGiniComplementConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureGlobalUserGiniComplement<>(feature, userFeat);
    }
