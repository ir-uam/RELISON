...
import es.uam.eps.ir.relison.grid.diffusion.expiration.ExpirationParameterReader;
import es.uam.eps.ir.relison.grid.diffusion.propagation.PropagationParameterReader;
import es.uam.eps.ir.relison.grid.diffusion.selection.SelectionParameterReader;
import es.uam.eps.ir.relison.grid.diffusion.sight.SightParameterReader;
import es.uam.eps.ir.relison.grid.diffusion.update.UpdateParameterReader;
