...
import es.uam.eps.ir.relison.diffusion.metrics.features.indiv.FeatureIndividualEntropy;
 ...
 *
 * @see FeatureIndividualEntropy
 */
public class FeatureIndividualEntropyConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new FeatureIndividualEntropy<>(features, userParam, unique);
    }
