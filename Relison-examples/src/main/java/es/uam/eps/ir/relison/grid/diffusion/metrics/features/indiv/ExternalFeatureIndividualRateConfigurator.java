...
import es.uam.eps.ir.relison.diffusion.metrics.features.indiv.ExternalFeatureIndividualRate;
 ...
 *
 * @see ExternalFeatureIndividualRate
 */
public class ExternalFeatureIndividualRateConfigurator<U extends Serializable,I extends Serializable, F> implements MetricConfigurator<U,I, F>
{
    /**
    ...
    public SimulationMetric<U, I, F> configure(Parameters params)
    {
        ...
        return new ExternalFeatureIndividualRate<>(parameter, userFeats, unique);
    }
