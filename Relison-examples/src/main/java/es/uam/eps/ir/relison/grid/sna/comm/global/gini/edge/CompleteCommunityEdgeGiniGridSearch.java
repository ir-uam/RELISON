...
import es.uam.eps.ir.relison.sna.metrics.communities.graph.gini.edges.CompleteCommunityEdgeGini;

import java.util.HashMap;
import java.util.Map;
import java.util.function.Supplier;

import static es.uam.eps.ir.relison.grid.sna.comm.global.GlobalCommunityMetricIdentifiers.COMPLETECOMMUNITYEDGEGINI;
