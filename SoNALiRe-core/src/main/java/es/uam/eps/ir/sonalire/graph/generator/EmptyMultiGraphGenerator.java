...
import es.uam.eps.ir.sonalire.graph.multigraph.fast.FastDirectedUnweightedMultiGraph;
import es.uam.eps.ir.sonalire.graph.multigraph.fast.FastDirectedWeightedMultiGraph;
import es.uam.eps.ir.sonalire.graph.multigraph.fast.FastUndirectedUnweightedMultiGraph;
import es.uam.eps.ir.sonalire.graph.multigraph.fast.FastUndirectedWeightedMultiGraph;
