 ...
 */
package es.uam.eps.ir.sonalire.graph.edges.fast;

import es.uam.eps.ir.ranksys.fast.preference.IdxPref;
import es.uam.eps.ir.sonalire.graph.edges.EdgeType;
import es.uam.eps.ir.sonalire.graph.edges.EdgeWeight;
import es.uam.eps.ir.sonalire.graph.edges.UndirectedEdges;
import es.uam.eps.ir.sonalire.graph.edges.UnweightedEdges;
import es.uam.eps.ir.sonalire.index.IdxValue;
import es.uam.eps.ir.sonalire.index.fast.FastUnweightedAutoRelation;
