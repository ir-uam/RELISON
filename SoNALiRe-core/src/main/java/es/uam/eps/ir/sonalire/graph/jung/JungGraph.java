 ...
 */
package es.uam.eps.ir.sonalire.graph.jung;

import edu.uci.ics.jung.graph.Graph;
import es.uam.eps.ir.sonalire.graph.UnweightedGraph;
import es.uam.eps.ir.sonalire.graph.Weight;
import es.uam.eps.ir.sonalire.graph.edges.EdgeOrientation;
import es.uam.eps.ir.sonalire.graph.edges.EdgeType;
import es.uam.eps.ir.sonalire.graph.generator.ComplementaryGraphGenerator;
...
public abstract class JungGraph<U> implements UnweightedGraph<U>
{
    ...
    @Override
    public es.uam.eps.ir.sonalire.graph.Graph<U> complement()
    {
