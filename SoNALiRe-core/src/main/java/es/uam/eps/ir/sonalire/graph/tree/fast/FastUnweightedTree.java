 ...
 */
package es.uam.eps.ir.sonalire.graph.tree.fast;

import es.uam.eps.ir.sonalire.graph.edges.EdgeOrientation;
import es.uam.eps.ir.sonalire.graph.edges.EdgeWeight;
import es.uam.eps.ir.sonalire.graph.edges.fast.FastDirectedUnweightedEdges;
import es.uam.eps.ir.sonalire.graph.tree.Tree;
import es.uam.eps.ir.sonalire.graph.tree.UnweightedTree;
