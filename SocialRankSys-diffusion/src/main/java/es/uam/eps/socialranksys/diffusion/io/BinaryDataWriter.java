 ...
 */
package es.uam.eps.socialranksys.diffusion.io;

import es.uam.eps.ir.socialranksys.index.Index;
import es.uam.eps.ir.socialranksys.io.graph.BinaryGraphWriter;
import es.uam.eps.ir.socialranksys.io.graph.GraphWriter;
import es.uam.eps.ir.socialranksys.utils.datatypes.Tuple2ol;
